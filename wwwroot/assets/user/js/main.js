...
(function ($) {
	...
	function price_slider() {
		...
		var selectMinPrice = parseFloat($("#slider-range").data("selectminprice"));
		var selectMaxPrice = parseFloat($("#slider-range").data("selectmaxprice"));

		$("#slider-range").slider({
			range: true,
			min: minPrice,
			max: maxPrice,
			values: [selectMinPrice, selectMaxPrice],
	...
	function color_swacthes(){
		$(".swacth-list").each(function () {
			var swacthList = $(this);
			var checkboxes = swacthList.find("input[type='checkbox']");
			var labels = swacthList.find(".swacth-btn");

			// Bắt sự kiện change của input checkbox
			checkboxes.on("change", function () {
				var checkbox = $(this);
				var checkboxId = checkbox.attr('id');
				var label = swacthList.find('label[for="' + checkboxId + '"]');
