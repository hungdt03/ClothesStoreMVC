        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ESize = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZoomImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToTypeUser = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Nike is a global brand known for its sports apparel and accessories.", true, "Nike" },
                    { 2, "Adidas offers a range of sportswear, footwear, and accessories.", true, "Adidas" },
                    { 3, "Puma is known for its athletic footwear, apparel, and accessories.", true, "Puma" },
                    { 4, "Levi's is a popular brand for jeans and casual wear.", true, "Levi's" },
                    { 5, "H&M provides a variety of fashion-forward clothing and accessories.", true, "H&M" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Clothing for men", true, "Men's Clothing", null },
                    { 2, "Clothing for women", true, "Women's Clothing", null },
                    { 3, "Clothing for kids", true, "Kid's Clothing", null },
                    { 4, "Shoes and footwear", true, "Footwear", null },
                    { 5, "Fashion accessories", true, "Accessories", null }
                });
            ...
            migrationBuilder.InsertData(
                table: "Sizes",
                columns: new[] { "Id", "ESize", "IsActive", "MaxHeight", "MaxWeight", "MinHeight", "MinWeight" },
                values: new object[,]
                {
                    { 1, "S", true, 165.0, 60.0, 150.0, 50.0 },
                    { 2, "M", true, 175.0, 70.0, 165.0, 60.0 },
                    { 3, "L", true, 185.0, 80.0, 175.0, 70.0 },
                    { 4, "XL", true, 195.0, 90.0, 185.0, 80.0 },
                    { 5, "XXL", true, 205.0, 100.0, 195.0, 90.0 }
                });
